...
if vips_init("uq_swaylock") != 0: quit("vips_init() failed")
...
outputs.apply(proc(o: string) = discard startProcess("grim", args = ["-t", "jpeg", "-q", "80", "-o", o, filename(o)], options = {poUsePath}).waitForExit())
outputs.apply(proc(o: string) = blur(filename(o), filename(o), 8))
